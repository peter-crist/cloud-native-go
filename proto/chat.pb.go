...
var file_proto_chat_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x63, 0x68, 0x61, 0x74, 0x22, 0x23, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75,
	...
	0x52, 0x03, 0x73, 0x68, 0x61, 0x32, 0x2f, 0x0a, 0x04, 0x43, 0x68, 0x61, 0x74, 0x12, 0x27, 0x0a,
	0x04, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x0d, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x52, 0x65, 0x71,
...
var file_proto_chat_proto_depIdxs = []int32{
	0, // 0: chat.Chat.Send:input_type -> chat.Request
	1, // 1: chat.Chat.Send:output_type -> chat.Response
...
func (c *chatClient) Send(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (*UnimplementedChatServer) Send(context.Context, *Request) (*Response, error) {
...
func _Chat_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).Send(ctx, req.(*Request))
	}
